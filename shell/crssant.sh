...
#       Note - "WorkPath" must be the SAME directory of mapping.sh output files.
...
function crssant() {
    ...
    python3 $ScriptPath/crssant/CRSSANT-master/scripts/merger_v2.py $Outprefix'_prigap1_filtered.sam' $Outprefix'_pritrans.sam' $Outprefix'_pri_crssant.sam' both
